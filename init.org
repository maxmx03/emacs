...
#+begin_src emacs-lisp :tangle yes
    (use-package general
      ...
      (start/leader-keys
        ...
        "Q" '(delete-window :wk "Close window")
      ...
      (start/leader-keys
        :keymaps 'normal
        "l" '(:ignore t :wk "LSP")
        "l h" '(lsp-describe-thing-at-point :wk "Show documentation")
        "l r" '(lsp-rename :wk "Rename")
        "l i" '(lsp-goto-implementation :wk "Go to Implementation")
        "l d" '(lsp-goto-type-definition :wk "Go to type definition"))
      )
#+end_src
...
#+begin_src emacs-lisp
  (use-package evil
    ...
    (define-key evil-normal-state-map (kbd "s s") 'split-window-below)
    (define-key evil-normal-state-map (kbd "s v") 'split-window-right)
