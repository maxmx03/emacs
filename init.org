...
- [[#eglot-and-mason][Eglot and Mason]]
- [[#completion][Completion]]
  - [[#ordeless][Ordeless]]
  - [[#vertico-and-marginalia][Vertico and Marginalia]]
- [[#ws-butler][WS butler]]
- [[#eat-emulate-a-terminal][Eat (Emulate A Terminal)]]
- [[#dired-and-divirsh][Dired and Divirsh]]
...
#+begin_src emacs-lisp
  ...
  (use-package evil-collection
    ...
    (setq evil-collection-mode-list '(dired ibuffer magit consult info (package-menu package) bookmark dashboard))
